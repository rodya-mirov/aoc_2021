...
pub fn a() -> u64 {
    a_with_input("./src/day04/4a_full.txt")
}
...
pub fn b() -> u64 {
    b_with_input("./src/day04/4a_full.txt")
}
...
mod tests {
    ...
    fn a_sample_test() {
        let expected = 4512;
        let actual = a_with_input("./src/day04/4a_sample.txt");
    ...
    fn b_sample_test() {
        let expected = 1924;
        let actual = b_with_input("./src/day04/4a_sample.txt");
